package com.njwd.costreport.aop;

import com.njwd.costreport.constant.ErrorCode;
import com.njwd.costreport.entity.ApiMessage;
...
@ControllerAdvice("com.njwd.costreprot.controller")
